...
# Re-export the verification contract for callers that still import it from
# the original patch module.
from astra_verification import VerificationResult, verify, verify_command  # noqa: F401
